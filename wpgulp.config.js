...
const projectURL = 'https://papagees.test';
...
const textDomain = 'papagees';

// Name of the translation file.
const translationFile = 'papagees.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'papagees';

// Where can users report bugs.
const bugReport = 'https://AhmadAwais.com/contact/';

// Last translator Email ID.
const lastTranslator = 'Elliott Richmond <elliott@squareonemd.co.uk>';

// Team's Email ID.
const team = 'Elliott Richmond <elliott@squareonemd.co.uk>';
